...
const ClientDetails:React.FC<ClientDetailsProps> = ({ setShowClientDetails, client,}) => {
  ...
  return (
    <Container >
        ...
        {removeModal && <RemoveModal member = {client} setRemovwModal={setRemoveModal} removeModal={removeModal}/>}
    </Container>
  )
}
