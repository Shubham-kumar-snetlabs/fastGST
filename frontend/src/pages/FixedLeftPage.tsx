...
const FixedLeftPage = () => {
  return (
    <Container>
      <Content>
        <div>
          <Logo>{fixedLeftPageSVG}</Logo>
          <WelcomeHeading>Welcome to FastGST!</WelcomeHeading>
          <SubHeading>
            <p>Start your journey with us.</p>
          </SubHeading>
          <Description>
            <p>
              Streamlines client-CA communication by automatically forwarding
              OTPs for faster process.
            </p>
          </Description>
        </div>
        <CarouselContainer>
