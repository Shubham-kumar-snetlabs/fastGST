...
const Profile: React.FC<DashBoardLeftProps> = ({
  activeItem,
  setActiveItem,
}) => {
      ...
      <InnerRightContainer>
        ...
        <ContentContainer>
          <ContentMainContainer>
            <TitleContainer>
              <DashBoardTitle svg={ProfileBigIconSVG} headTitle="Profile" />
            </TitleContainer>
            <BodyContainer>
              ...
              <WindowContainer>
                <Routes>
                  ...
                  <Route
                    path="set-status/your-status"
                    element={<YourStatus />}
                  />
                  <Route path="set-away" element={<SetAway />} />
                  <Route
                    path="pause-notifications"
                    element={<p>Pause Notifications</p>}
                  />
                  <Route path="log-out" element={<p>Logging Out...</p>} />
                  <Route
                    path="delete-account"
                    element={<p>Deleting Account...</p>}
                  />
                </Routes>
              </WindowContainer>
            </BodyContainer>
