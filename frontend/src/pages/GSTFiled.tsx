...
const GSTFiled: React.FC<DashBoardLeftProps> = ({
  activeItem,
  setActiveItem,
}) => {
  ...
  const handleCopyOTP = () => {
    if (otpValue) navigator.clipboard.writeText(otpValue);
  };
          ...
          <ContentMainContainer>
            ...
            <BodyContainer>
              ...
              <BodyMainContainer>
                {CyberIconSVG}
                <InnerMainContainer>
                  { !showClientDetails && <TitleDiv>OTP Received!</TitleDiv>}
                  <DropdownDiv>
                    <DropdownComponent
                      height="54px"
                      width="276px"
                  ...
                  <DescriptionDiv>
                    <Description1>
                      You both saved your valuable time and efforts.
                    </Description1>
                    <Description2>
                      Use this OTP to complete the GST filing.
                    </Description2>
                  </DescriptionDiv>
                  <OTPTimerandButtonDiv>
                    <TimerandCopyDiv>
                      <Timer>
                        {TimerIconSVG} {formatTime(timeLeft)}
                      </Timer>
